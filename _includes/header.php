...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $sfcmBasePath ?>/vendors/mdi/css/materialdesignicons.min.css">
    <link rel="stylesheet" href="<?php echo $sfcmBasePath ?>/vendors/base/vendor.bundle.base.css">
